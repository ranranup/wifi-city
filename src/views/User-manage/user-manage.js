$(document).ready(function() {    
    ...
    $.getJSON(dataroot, function(data){
        ...
        for(var i=0;i<data.length;i++){
            data[i]["操作"]="<button  onclick='DeleteAp(\".del-ap\")'><img alt='delete'" +
                " src='../../image/delete.png'></button><button  onclick='AddAp(\".add-ap\")'><img alt='edict'" +
                "  src='../../image/edict.png'></button>";
            data[i]["详情"]="<a href='../User-profile/User-profile.html'>>></a>";
        }

        var cs = new table({
            "tableId":"cs_table",    //必须
            "headers":["用户名","姓名","部门","角色","备注","操作","详情"],   //必须
            "data":data,        //必须
