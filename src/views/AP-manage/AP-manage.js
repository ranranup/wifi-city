$(document).ready(function() {    
        ...
        success : function(data){
            ...
            for(var i=0;i<data.length;i++){
                data[i]["操作"]="<button  onclick='DeleteAp(event)'><img alt='delete'" +
                    " src='../../image/delete.png'></button><button onclick='AddAp()'><img alt='edict'" +
    ...
    //    var cs = new table({
    //        "tableId":"cs_table",    //必须
    //        "headers":["编号","AP名称","经度","纬度","备注","操作","详情"],   //必须
    //        "data":data,        //必须
    //        "displayNum": 10,    //必须   默认 10
    //        "groupDataNum":9  //可选    默认 10
    //    });
    ...
    function SearchAP(){
        $("#search_button").click(function(){
            ...
            $.ajax({
                ...
                //  data: JSON.stringify({"mac":"58:2b:c2:50:bd:8d"}),
                type : "GET",
                dataType : "json",
                success : function(data){
                    //data = {
                    //    "ap_id": 1,
                    //    "ap_mac": "58:2b:c2:50:bd:8d",
                    //    "ap_lat": "121.247922",
                    //    "ap_position": "宁波大楼",
                    //    "ap_lng": "30.158323"
                    //}
    ...
    function DeleteAp(event){
        showMask();
        $(".del-ap").show();
        console.log(event.srcElement.parentElement.parentElement.innerText);
    }
    function AddAp(){
        showMask();
        $(".add-ap").show();
